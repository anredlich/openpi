...
_CONFIGS = [
    ...
    #
    # ALOHA Sim Trossen configs. This config is used to demonstrate how to train on the trossen ai simulated environment.
    # This version v3 is designed to do full fine tuning with multiple task prompts, and initially to create norm stats for the newer trossen ai stationary robot.
    #
    TrainConfig(
        name="pi0_aloha_sim_trossen_ai_mem_finetune_v3", #the name is wrong, this is actually a full fine tune!
        model=pi0_config.Pi0Config(),
        #model=pi0_config.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
    ...
    #
    # ALOHA Sim Trossen configs. This config is used to demonstrate how to train on the trossen ai simulated environment.
    # This version v4 (redo of v3!) is designed to do full fine tuning with multiple task prompts, and initially to create norm stats for the newer trossen ai stationary robot.
    #
    TrainConfig(
